...
/datum/action/innate/slime_change/proc/change_form()
	...
	switch(select_alteration)
		...
		if("Markings")
			...
			H.update_body()
		if("DNA Specifics")
			var/dna_alteration = input(H, "Select what part of your DNA you'd like to alter", "DNA Alteration", "cancel") in list("Body Size", "Cancel") //ACULASTATION EDIT - HORNY REMOVAL
