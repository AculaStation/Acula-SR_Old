...
/mob/Login()
	...
	if(hud_used)
		...
		//hud_used.update_erp_ui_style(erp_ui_style2icon(client.prefs?.read_preference(/datum/preference/choiced/ui_style))) //SKYRAT EDIT - ADDITION - ERP ICONS FIX //ACULASTATION EDIT START - HORNY REMOVAL
